...
project = u'Sensirion SHT I²C Python Driver'
...
htmlhelp_basename = 'PythonDriverforSensirionI2cSht'
...
latex_documents = [
    (
        master_doc,
        'PythonDriverforSensirionI2cSht.tex',
        u'Python Driver for I²C SHT Documentation',
        u'Sensirion AG',
        'manual'
    ),
]
...
man_pages = [
    (
        master_doc,
        'pythondriverforsensirioni2csht',
        u'Python Driver for I²C SHT Documentation',
        [author],
        1
    )
...
intersphinx_mapping = {
    'sensirion_i2c_driver': (
        'https://sensirion.gitlab.sensirion.lokal/Python/python-i2c-driver/',
        None
    ),
}
